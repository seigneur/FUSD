...
function App() {
  ...
  const { data, isError, isLoading } = useBalance({
    ...
    chainId: chain?.id,
    token: '0x268F78793F20B11615eD5C4e076B288826E299ce',
    onSuccess(data) {
      console.log('Success', data)
    },
  })
  const porData:any = useContractRead({
    address: '0x4e9fc7480c16f3fe5d956c0759ee6b4808d1f5d7',
    abi: porabi,
                  ...
                  >
                    <div className="form-control">
                      <Select size="lg" value={value} onChange={setValue}>
                        ...
                        <Select.Option value={"Homer"}>CGT</Select.Option>
                        <Select.Option value={"Marge"}>WBTC</Select.Option>
                        <Select.Option value={"Bart"}>PAX</Select.Option>
                      </Select>
